...
Aqui teremos uma breve descrição do que cada middleware deve fazer e na seção [Especificação dos testes](#Específicação-dos-testes) você verá com mais detalhes o que precisa ser feito para satisfazer cada teste.
